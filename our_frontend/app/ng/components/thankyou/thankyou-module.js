angular.module('myApp.thankyou', ['ngResource', 'ui.router'])

.config(function ($stateProvider, $urlRouterProvider, thankyouState) {
    $stateProvider
        ...
        .state(thankyouState.name, thankyouState.options)
