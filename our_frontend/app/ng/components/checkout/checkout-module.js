angular.module('myApp.checkout', ['ngResource', 'ui.router'])

.config(function ($stateProvider,   $urlRouterProvider, checkoutState) {
    $stateProvider
        ...
        .state(checkoutState.name, checkoutState.options)
